...
public class Homepage{
    ...
    @FindBy(xpath = "//img[@alt='Hot Rolled']")
    private WebElement ProductCategoriesName;

    @FindBy(xpath = "//div[text()='Hot Rolled']")
    private WebElement CategoriesNameonPLP;
    ...
    public void search(String searchText) throws Throwable {
       ...
       if (ProductCategoriesName.isDisplayed() && ProductCategoriesName.isEnabled()) {
        ProductCategoriesName.click();
       }


       CategoriesNameonPLP.click();
       String categoryNameFromPLP = CategoriesNameonPLP.getText();
